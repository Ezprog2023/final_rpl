          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Data Tabungan Saya</h4>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <?php
                          // Asumsikan Anda memiliki nama pengguna pengguna yang sudah login disimpan dalam variabel sesi
